...
NioApp = function (NioApp, $, window, document) {
    ...
    NioApp.Plugins.particles = function () {
        ...
        if ($particles_bg.length) {
            $particles_bg.each(function(){
                var $self = $(this);
                var $self_id = $self.attr('id');
                
                console.log("Initializing particles for ID:", $self_id); // Debugging line
    
                var _pt_base = ($self.data('pt-base')) ? $self.data('pt-base') : '#fff', 
                ...
                console.log("Base color:", _pt_base); // Debugging line
                console.log("Shape color:", _pt_shape); // Debugging line
                console.log("Line color:", _pt_line); // Debugging line
